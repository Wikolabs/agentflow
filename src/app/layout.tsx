...
export const metadata: Metadata = {
  title: "AgentFlow — Orchestrez vos agents IA visuellement",
  description: "Pipelines d'agents IA visuels — connectez, testez et déployez vos workflows IA sans code en 10 minutes.",
};
